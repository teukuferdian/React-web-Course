      ...
      <header className="w-100 min-vh-100 d-flex align-items-center overflow-hidden">
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              <h1 className="nb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Temukan <br /> <span>Bakat Kreatifmu</span> <br /> Bersama Kami
              </h1>
              <p className="nb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Accusantium repellendus officia, veritatis dolores labore
                itaque.
              </p>
              <button
